...
{
    public partial class SalaryGenerator : Form
    {
        ...
        private void GenerateSalary()
        {
            try
            {
                ...
                else
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SP_CREATE_SALARY_SHEET", obCon);
        ...
        private void CheckExists()
        {
            try
            {
                ...
                cmd.CommandText = "Select* From tblSalarySheet where _Month=@_Month And _Year=@_Year";
        ...
        private void LoadData()
        {
            ...
            ds.CommandText = "select* from tblSalary";
