...
{
    public partial class OTBusinessOffice : Form
    {
        public OTBusinessOffice()
        {
            InitializeComponent();
       ...
       // private bool chkValue;
        ...
        private void GetOtInfo()
        {
            bool chk = chkValue();
            DataTable dt = new BedHistoryManager().GetOtInfo(FromDate.Value, ToDate.Value);
