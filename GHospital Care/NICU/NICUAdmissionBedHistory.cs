...
{
    public partial class NICUAdmissionBedHistory : Form
    {
        public NICUAdmissionBedHistory()
        {
            InitializeComponent();
            GetIpInfo();
        }
        ...
        {
            DataTable dt = new BedHistoryManager().GetFreeOccupiedBedNICU(FreeOccupied,"All Ward");
        ...
        {
            DataTable dt = new BedHistoryManager().CountFreeOccupiedBedNICU(FreeOccupied, cmbWardorCabin.Text);
        ...
        {
            DataTable dt = new BedHistoryManager().GetNICUpatientList(FromDate.Value, ToDate.Value);
            gridControl1.DataSource = dt;
            CountPatient();
        }
        private void GetBedCabinList()
        {
            DataTable dt = new BedHistoryManager().GetIpCabinBedListNICU(patientID);
        ...
        {
            DataTable dt = new BedHistoryManager().CountNICU(FromDate.Value, ToDate.Value);
            DataTable dt1 = new BedHistoryManager().CountNICU(System.DateTime.Today, System.DateTime.Today);
            DataTable dt2 = new BedHistoryManager().CountNICUDischarge(System.DateTime.Today, System.DateTime.Today);

            txtTotalPatient.Text = dt.Rows[0][0].ToString();
            txtTodayAdmit.Text = dt1.Rows[0][0].ToString();
            txtDischarge.Text = dt2.Rows[0][0].ToString();
            //txtReg.Text = dt.Rows[0][0].ToString();
        }
