...
{
    public partial class NICUDischargeRequest : Form
    {
        private NICUDischargeReqManager aMedicalManager;
        ...
        private void cmbPatient_EditValueChanged(object sender, EventArgs e)
        {
            if(flag == false)
               {
                   PatientByOPID(cmbPatient.Properties.View.GetFocusedRowCellValue("RegNo").ToString());
        ...
        {
            tempDrug = null;
            tempDrug = ToDataTable(new DischargeRequestNICU().DischageDrugDetialses);
